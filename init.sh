...
sudo apt update
sudo apt install -y tk-dev tcl-dev build-essential zlib1g-dev libssl-dev libffi-dev libbz2-dev liblzma-dev libncurses5-dev libncursesw5-dev libreadline-dev libsqlite3-dev wget curl
